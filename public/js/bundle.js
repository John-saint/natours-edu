...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWFuc3VuIiwiYSI6ImNrangxNWRhOTBvMjkyb2xjamN3NjlrbTIifQ.8O7B-NQvK7gX_-GBt4fvRg';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              // url: 'http://127.0.0.1:3000/api/v1/users/logout', not going to work in production
              url: '/api/v1/users/logout'
            });

          case 3:
            res = _context2.sent;
            // set to true so that will then force a reload from the server, not from the browser cache
...
var stripe = Stripe('pk_test_51IEnYbAee10ofx4wFOTp82ZqIih20Q5xmAP0PxnP0xzi7cWKTDHwXNXdeYvDKmntYBX5gPNnX0SwTlQPYD61TDr5004cpNTDLw');
...
var bookBtn = document.getElementById('book-tour'); // ADDINTIONAL FOR REVIEWS
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // CURRENT USER WANTS TO UPDATE FORM
